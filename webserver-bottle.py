...
def controllers(filename):
	return static_file(filename, root="./controllers")

@get('/hamburger/<filename:re:.*\.js>')
def hamburger(filename):
	return static_file(filename, root="./hamburger")
